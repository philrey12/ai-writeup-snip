    ...
    return (
        <section className='mt-16 w-full max-w-xl'>
            ...
            <div className='flex flex-col w-full gap-2'>
                ...
                <p className='text-sm text-red-400 text-center my-2 px-10'>Note:<br />This is just a demo and only using a free tier of the API service that has limited usage</p>
